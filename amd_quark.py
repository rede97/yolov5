...
if __name__ == "__main__":
    ...
    input_model_path = "runs/train/exp7/weights/best.onnx"
    quantized_model_path = "runs/train/exp7/weights/best-int.onnx"
    calib_data_path = "../datasets/widerface/val/images"
